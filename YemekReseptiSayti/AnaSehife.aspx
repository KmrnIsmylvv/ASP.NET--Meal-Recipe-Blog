<%@ Page Title="" Language="C#" MasterPageFile="~/Istifadeci.Master" AutoEventWireup="true" CodeBehind="AnaSehife.aspx.cs" Inherits="YemekReseptiSayti.AnaSehife" %>
            ...
            <table class="auto-style5">
                <tr>
                    <td style="background-color: #FF9966">
                        ...
                        <a href="YemekDetal.aspx?YemekId=<%# Eval("YemekId") %>"> <asp:Label ID="Label3" runat="server" style="font-weight: 700; font-size: x-large; color: #990033;" Text='<%# Eval("YemekAd") %>'></asp:Label> </a>
