<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="GununYemeyiAdmin.aspx.cs" Inherits="YemekReseptiSayti.GununYemeyiAdmin" %>
                    ...
                    <tr>
                        ...
                        <td class="auto-style11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          ...
                          <a href="YemekEdit.aspx?YemekId=<%# Eval("YemekId") %>">
                              <asp:Image ID="Image8" runat="server" Height="30px" ImageUrl="~/İcons/choose.png" Width="30px" /></a>
